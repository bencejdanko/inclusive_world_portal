...
APPS_DIR = BASE_DIR / "inclusive_world_portal"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///inclusive_world_portal",
    ),
}
...
MIGRATION_MODULES = {"sites": "inclusive_world_portal.contrib.sites.migrations"}
...
# Parse EMAIL_URL to populate SMTP settings if provided (uses django-environ)
# e.g. EMAIL_URL=smtp+tls://user%40domain.com:APP_PASSWORD@smtp.gmail.com:587
EMAIL_CONFIG = env.email_url("EMAIL_URL", default="smtp://localhost:25")
vars().update(EMAIL_CONFIG)

# From / sender identities (env overrides, otherwise sane defaults)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[inclusive-world-portal] ",
)
...
ADMINS = [("""Bence Danko""", "bence.danko@inclusiveworld.org")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "inclusive_world_portal.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "inclusive_world_portal.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "inclusive_world_portal.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
