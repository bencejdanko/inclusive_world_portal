...
import inclusive_world_portal.forms.models.form
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_method', models.SmallIntegerField(choices=[(1, 'By question'), (0, 'All in one page')], default=0, verbose_name='Display method')),
                ...
                ('expire_date', models.DateField(blank=True, default=inclusive_world_portal.forms.models.form.in_duration_day, verbose_name='Expiration date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='portal_forms.form', verbose_name='Form')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='portal_forms.question', verbose_name='Question')),
            ],
        ),
        migrations.CreateModel(
            name='Response',
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='portal_forms.form', verbose_name='Form')),
            ],
            options={
