...
class Response(models.Model):
    """A response object is a collection of questions and answers with a unique interview uuid."""

    created = models.DateTimeField(_("Creation date"), auto_now_add=True)
    updated = models.DateTimeField(_("Update date"), auto_now=True)
    survey = models.ForeignKey(Form, on_delete=models.CASCADE, verbose_name=_("Form"), related_name="responses")
