...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='document',
            name='source_survey',
            field=models.ForeignKey(blank=True, help_text='Survey used to auto-generate this document (if applicable)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='generated_documents', to='portal_forms.form'),
        ),
        migrations.AddField(
            model_name='document',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Surveys that must be completed before registration', related_name='enrollment_requirements', to='portal_forms.form'),
        ),
        migrations.AddIndex(
            model_name='document',
